...
matriz_desordenada = np.array(arrays)

plt.imshow(matriz_desordenada,cmap='hot', interpolation = 'nearest')
plt.colorbar(label='Temperatura')
plt.title('Grafico de temperatura con matrices desordenadas')
plt.xlabel('Columnas del array')
plt.ylabel('Número del array')
plt.show()
...
matriz_ordenada = np.array(arrays)

print(matriz_ordenada)

plt.imshow(matriz_ordenada,cmap='hot', interpolation = 'nearest')
plt.colorbar(label='Temperatura')
plt.title('Grafico de temperatura con matrices ordenadas')
plt.xlabel('Columnas del array')
plt.ylabel('Número del array')
plt.show()
